...
public class UniversalFileSearch {
    public static void main(String[] args) {
        String askPath = "Введите адрес каталога книг, для завершения прошраммы введите слово - end: ";
        String askFileName = "Ведите имя файла в котором хотите осуществить поиск, для завершения прошраммы введите слово - end: ";
        String askSearch = "Введите слово которое хотите найти или слово - back ,для выбора другого файла, для завершения прошраммы введите слово - end: ";
     ...
     * @param catalog каталог файлов переданный пользоватлем.
